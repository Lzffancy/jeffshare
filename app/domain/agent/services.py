...
from .entities import AgentStep, AgentVersion, StepLog
from .value_objects import StepType
...
class StepExecutor:
    ...
    放在 domain 层而非 infrastructure，因为它只编排 call/transform 的分发逻辑，
