"""Domain entities — dataclass 定义

所有实体使用 @dataclass，值对象使用 frozen=True。
遵循 DDD：在此层不引入任何 ORM / SQL / HTTP 依赖。
"""
...
from .value_objects import ConfigStatus, StepType, WorkflowType
...
class AgentDefinition:
    ...
    def from_row(cls, row: dict[str, Any]) -> AgentDefinition:
        from .value_objects import WorkflowType
