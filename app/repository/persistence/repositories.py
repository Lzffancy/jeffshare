"""Repository persistence — 仓储实现

实现 entity.ports 定义的仓储接口。
"""
...
from app.entity.ports import IAgentConfigRepo, IExecutionRepo
from app.entity.agent import (
    AgentDefinition,
    AgentVersion,
    AgentStep,
    ModelParams,
)
from app.entity.values import ConfigStatus, StepType
